...
- Build a safer production baseline: [Your First Pipeline](book/src/content/docs/index.mdx)
...
| [Your First Pipeline](book/src/content/docs/index.mdx) | Production config with monitoring and validation |
