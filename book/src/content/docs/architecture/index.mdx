...
|-------|-------------------|
| [Pipeline Design](/memagent/architecture/pipeline/) | Data flow, persistence modes, end-to-end ack semantics, multi-source pipelines |
| [Scanner](/memagent/architecture/scanner/) | SIMD structural indexing, zero-copy StringViewArray, field pushdown |
| [Performance](/memagent/architecture/performance/) | Benchmarks (2.8M lines/sec), stage breakdown, memory profile |
