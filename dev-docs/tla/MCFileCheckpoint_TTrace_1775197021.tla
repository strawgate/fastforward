---- MODULE MCFileCheckpoint_TTrace_1775197021 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MCFileCheckpoint_TTrace_1775197021.json", _TETrace)
...
\*
\*trace == IODeserialize("MCFileCheckpoint_TTrace_1775197021.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([read_offset |-> 0,file_content |-> <<>>,next_identity |-> 2,next_line_id |-> 1,alive |-> TRUE,rotated_identity |-> 0,rotated_content |-> <<>>,rotation_count |-> 0,checkpoints |-> <<0, 0>>,rotated_active |-> FALSE,in_flight_offset |-> 0,in_flight_source |-> 0,crash_count |-> 0,emitted |-> <<>>,file_identity |-> 1,framer_source |-> 0,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>]),
    ([read_offset |-> 0,file_content |-> <<>>,next_identity |-> 2,next_line_id |-> 1,alive |-> FALSE,rotated_identity |-> 0,rotated_content |-> <<>>,rotation_count |-> ,checkpoints |-> <<0, 0>>,rotated_active |-> FALSE,in_flight_offset |-> 0,in_flight_source |-> 0,crash_count |-> 1,emitted |-> <<>>,file_identity |-> 1,framer_source |-> 0,pipeline_batch |-> <<>>,rotated_offset |-> 0,in_flight_batch |-> <<>>,framer_buf |-> <<>>])
    >>
----
...
---- CONFIG MCFileCheckpoint_TTrace_1775197021 ----
CONSTANTS
    MaxLines = 4
    MaxCrashes = 1
    MaxRotations = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Apr 03 06:17:01 UTC 2026