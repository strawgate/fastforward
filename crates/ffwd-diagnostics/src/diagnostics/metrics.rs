...
impl PipelineMetrics {
    pub fn new(name: impl Into<String>, transform_sql: impl Into<String>, meter: &Meter) -> Self {
        ...
        Self {
            ...
            otel_cadence_fast_repolls: meter.u64_counter("ffwd_input_cadence_fast_repolls").build(),
            otel_cadence_idle_sleeps: meter.u64_counter("ffwd_input_cadence_idle_sleeps").build(),
