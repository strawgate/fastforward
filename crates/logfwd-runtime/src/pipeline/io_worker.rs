...
#[cfg(not(feature = "turmoil"))]
use logfwd_io::input::{CriMetadata, FramedReadEvent, SourceEvent};
#[cfg(not(feature = "turmoil"))]
...
pub(super) fn flush_buf(
    ...
    let chunk = IoWorkItem::RawBatch(RawBatch {
        bytes: data,
        checkpoints,
...
#[cfg(not(feature = "turmoil"))]
#[allow(clippy::too_many_arguments)]
pub(super) fn process_source_events(
