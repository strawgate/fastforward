...
impl OutputConfigV2 {
    ...
    ///
    /// ```
    /// use ffwd_config::{OutputConfigV2, TcpOutputConfig, StdoutOutputConfig};
    ///
    ...
    ///
    /// ```
    /// use ffwd_config::{AuthConfig, OtlpOutputConfig, OutputConfigV2, TcpOutputConfig};
    ///
